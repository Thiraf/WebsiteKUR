...
<body id="app" data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    <nav id="logonavbar" class="pt-3">
        <div class="container">
            <div class="text-right justify-content-end">
                <img src="{{ asset('images/logo.png') }}" class="pl-3" alt="" style="width: 180px">
            </div>
        </div>
    </nav>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link text-dark" href="{{url('/')}}">Beranda <span
                    ...
                    <li class="nav-item">
                        <a class="btn btn-danger text-white mr-2 mb-2" href="{{url('/member/login')}}"><i
                                class="fas fa-sign-in-alt"></i> Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-danger text-white" href="{{url('/member/register')}}"><i
                                class="fas fa-file"></i> Daftar</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <footer>
        <div class="container">
            <div class="section-penyalur-kur text-center">
                <h3 class="mb-5"><b>Bank Penyalur KUR <br> di Daerah Istimewa Yogyakarta</b></h3>
                {{-- <span class="ft-13">berikut adalah Bank-Bank penyalur KUR yang <br> aktif di website KUR JOGJA</span> --}}
                <div class="row mt-4 section-bank-center justify-content-center">
                    @foreach($banks as $bank)
                    <div class="col-3 col-sm-4 col-md-2" data-aos="fade-up" data-aos-duration="1000"
                        data-aos-delay="100">
                        <img src={{$bank->logo}} alt="" width="100%">
                    </div>
                    {{-- <div class="col-12 col-md-2">
							<img src="{{url("/")}}/front/img/bank/sinarmas.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/papua_bank.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/national.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/mandiri-bank.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/jateng-bank.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/bukopin-bank.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/btn-bank.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/bri-bank.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/bpd_diy.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/bni-bank.jpg" alt="" width="100%">
                </div>
                <div class="col-12 col-md-2">
                    <img src="{{url("/")}}/front/img/bank/bca-bank.jpg" alt="" width="100%">
                </div> --}}
                @endforeach
            </div>
        </div>
        ...
        <div class="container">
            <div class="footer text-center">
                <p class="ft-13">Copyright &copy; {{date('Y')}} - Tim Percepatan Akses Keuangan Daerah DIY. All Rights
                    Reserved</p>
            </div>
        </div>
    </footer>
