<aside id="aside" class="app-aside hidden-xs bg-dark">
    <div class="aside-wrap">
        <div class="navi-wrap">
            <!-- user -->
            <div clss="clearfix hidden-xs text-center hide" id="aside-user">
                <div class="dropdown wrapper">
                    <a href="app.page.profile">
                        <span clss="thumb-lg w-auto-folded avatar m-t-sm">
                            <img src="{{asset('theme/html/img/a0.jpg')}}" class="img-full" alt="...">
                        </span>
                    </a>
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle hidden-folded">
                        <span class="clear">
                            <span class="lock m-t-sm">
                    ...
                    <ul class="dropdown-menu  w hidden-folded">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a ref="page_signin.html">Logout</a>
                        </li>
                    </ul>
                    <!-- / dropdown ->
                </div>
            ...
            <!-- / user -->
                    ...
                    <nav ui-nav class="navi clearfix">
                        <ul class="nav">
                            <li class="h
    i
dden-folded padder m-t m-b-sm text-muted text-xs">
                                <span>Dashboard</span>
                            </li>
                            <li>
