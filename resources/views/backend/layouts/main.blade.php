...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('theme/libs/dropify/css/dropify.min.css') }}" type="text/css" />
  ...
  <link rel="stylesheet" href="{{ asset('theme/libs/jquery/bootstrap/dist/css/bootstrap.min.css') }}" type="text/css" />
  <link rel="stylesheet" href="{{ asset('theme/libs/jquery/plugins/integration/bootstrap/3/dataTables.bootstrap.css') }}" type="text/css" />
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/css/select2.min.css" rel="stylesheet" />
  <link rel="stylesheet" href="{{ asset('theme/libs/datepicker/css/bootstrap-datepicker.min.css') }}">
...
<div class="app app-header-fixed ">
  ...
  @include('backend.components.modals.confirmation')



</div>

<script src="{{ asset('theme/libs/jquery/jquery/dist/jquery.min.js') }}"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js"></script>
<script src="{{ asset('theme/libs/jquery/bootstrap/dist/js/bootstrap.min.js') }}"></script>
...
<script src="{{ asset('theme/libs/dropify/js/dropify.min.js') }}"></script>
<script src="https://use.fontawesome.com/51e27bac85.js"></script>
<script src="{{ asset('theme/libs/jquery/datatables/media/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('theme/libs/jquery/plugins/integration/bootstrap/3/dataTables.bootstrap.js') }}"></script>
<script src="{{ asset('theme/libs/datepicker/js/bootstrap-datepicker.min.js') }}"></script>
<script>
