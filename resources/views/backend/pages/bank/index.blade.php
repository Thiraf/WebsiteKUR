...
@section('actions')
    <a href="#" @click="addItem()" class="btn btn-addon btn-info"><i class="fa fa-plus"></i> Tambah Bank</a>
@endsection
...
@section('content')
    ...
    @include('backend.pages.bank.modals.form')
            ...
            if (confirm("Apakah Anda yakin ingin menghapus item ini?")) {
                ...
                submitForm() {
                    ...
                    if(!this.isEdit) {
                        ...
                        axios.post('{{url("/")}}/api/bank', formData, {
                            headers: {
                        ...
                        axios.post('{{url("/")}}/api/bank/'+self.idEdit, formData, {
                            headers: {
                                    'Content-Type': 'multipart/form-data'
                            }
                        })
