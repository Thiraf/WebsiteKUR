...
@endpush
<!-- The Modal -->
<div class="modal fade" id="form-bank-modal" data-backdrop="static" data-keyboard="false">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="file" class="dropify" :required="!isEdit" name="bank_logo" data-max-file-size="1M" data-allowed-file-extensions="png jpg jpeg" >
                        </div>   
                    </div>
                </div>             
            </div>
