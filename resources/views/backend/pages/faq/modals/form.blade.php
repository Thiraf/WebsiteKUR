...
@endpush
<!-- The Modal -->
<div class="modal fade" id="form-faq-modal"   data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
        <form action="" id="formFAQ" v-on:submit.prevent="submitForm()" enctype="multipart/form-data">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">@{{ !isEdit ? 'Tambah FAQ' : 'Edit FAQ' }}</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="faq.title" required>
                        </div>  
                        <div class="form-group">
