...
@endpush
<!-- The Modal -->
<div class="modal fade" id="form-news-modal" data-backdrop="static" data-keyboard="false">
        ...
        <form action="" id="formFAQ" v-on:submit.prevent="submitForm()" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="news.title" required>
                        </div>
			<?php /*
			<div class="form-group">
			...
			*/ ?>
                        <div class="form-group">
                            ...
                            <select id="news-category" name="news-category" v-model="news.category_news_id" class="form-control">
                                <option v-for="item in newscategory" v-bind:value="item.id"> @{{ item.name }}</option>
                            </select>
                        </div>
                        <div class="form-group">
