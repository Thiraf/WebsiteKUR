...
@endpush
<!-- The Modal -->
<div class="modal fade" id="form-requirement-modal"   data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
        <form action="" id="formFAQ" v-on:submit.prevent="submitForm()" enctype="multipart/form-data">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">@{{ !isEdit ? 'Tambah Informasi' : 'Edit Informasi' }}</h4>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="requirement.title" required>
                        </div>
                        <div class="form-group">
                            <label for="">Short Deskripsi</label>
                            <textarea name="" id="" cols="30" rows="10" class="form-control" v-model="requirement.short_description"></textarea>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="file" class="dropify"  :required="!isEdit" name="photo"  data-max-file-size="1M">
                        </div>  
                    </div>
                </div>             
            </div>
