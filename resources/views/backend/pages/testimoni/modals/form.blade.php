        ...
        <div class="modal-content">
            <form action="" id="formFAQ" v-on:submit.prevent="submitForm()" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <div ui-jq="wysiwyg" class="form-control"
                                        style="overflow:scroll;height:200px;max-height:200px" id="inputJawaban">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="file" class="dropify" :required="!isEdit" name="photo"
                                    data-max-file-size="1M" data-allowed-file-extensions="png jpg ico bmp">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-addon" data-dismiss="modal" @click="reset()"><i
                            class="fa fa-arrow-left"></i> Batal</button>
                    <button type="submit" class="btn btn-primary btn-addon btn-save"><i class="fa fa-save"></i>
                        Simpan</button>
                </div>
            </form>
